...
class NoisePanel:
    ...
    def _build_ui(self):
        ...
        self._section_title(self._card, "NOISE GENERATION")

        ctk.CTkLabel(self._card, text="Noise Type:", font=FONT_SMALL, text_color=TEXT_DIM).pack(
            anchor="w", padx=12
        )
        ...
        self._strength_frame = ctk.CTkFrame(self._card, fg_color="transparent")
        ...
        self._strength_entry = ctk.CTkEntry(
            self._strength_frame,
        ...
        self._pepper_frame = ctk.CTkFrame(self._card, fg_color="transparent")
        ctk.CTkLabel(self._pepper_frame, text="Salt Ratio:", font=FONT_SMALL, text_color=TEXT_DIM).pack(
            anchor="w"
        )
        self._salt_ratio_entry = ctk.CTkEntry(
            self._pepper_frame,
    ...
    def _divider(self):
        ctk.CTkFrame(self.parent, height=2, fg_color=BORDER_CYAN).pack(fill="x", padx=8, pady=8)
